...
export function getRoleKey(user) {
  ...
  if (level >= 3) {
    return Number(user.positionId) === POSITION_TRUONG_PHONG ? 'truongPhong' : 'truongCa';
  }
...
export const TRUONG_CA_SUMMARY = {
  ...
  tagline: 'Phê duyệt lịch, phiếu việc, tài liệu; WO khẩn: Trưởng ca bước 1 → Trưởng phòng bước 2. Điều phối, giám sát checklist & tài sản.',
  flows: [
...
const ROLE_IDX = {
  congNhan: 0, kyThuat: 1, truongCa: 2, truongPhong: 2, admin: 3, bGD: 4,
};
