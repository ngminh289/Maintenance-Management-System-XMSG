...
export const remove   = asyncHandler(async (req, res) => { await service.remove(req.params.id); return ok(res, { message: 'Đã xóa nhóm.' }); });

export const addMember    = asyncHandler(async (req, res) =>
  ok(res, await service.addMember(req.params.id, Number(req.body.employeeId), req.body.roleNotes)));
